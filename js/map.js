...
(function(){
    ...
    getLayers: function() 
        {
            var self = this;
            var findlayers = ["Indicators", "Project Locations", "Project Counts", "Population", "Poverty", "Infant Mortality", "Number of Physicians", "Number of Households", "Soums","Unemployment", "Mines", "Licenses","EITI","Oil wells", "Oil fields", "District revenues", "Mineral deposits", "No Data"];
            ...
            jq.each(possibleLayers, function(layer) {
                    ...
                    if(Object.include(["Infant Mortality", "Population", "Poverty", "Number of Physicians", "Number of Households", "Soums","Unemployment"], possibleLayers[layer].title)) {
